...
import { splash, heroBgSm, heroBg, howItWorksBg, howItWorksBgSm, poolParty, ray1, ray2, ray3, ray4, ray5, vecLayer } from "./assets";
...
import { ProgressbarWrap, StartTimer, StartTimerInner, StartTimerSubtitle, StartTimerWrap } from "./components/StyledComponents";
...
const Home = (props: HomeProps) => {
  ...
  const onDialogExpanded = useCallback((expanded: SetStateAction<boolean>)=>{
  ...
  const onConnectWallet: MouseEventHandler<HTMLButtonElement> = useCallback((event)=>{
  ...
  return (
      <>
        ...
        <main className="main-sections" style={ openFlowDialog ? { position: 'fixed', left: 0, right: 0} : { position:'inherit', left:'inherit', right: 'inherit'}}>
          {/* hero */}
          <section className="hero hero-home">
            ...
            <div className="container">
              ...
              {guardStates.isLimitReached ? (
                <button
                  className={"btn btn-secondary btn-press btn-disabled"}
                  >
                    {connectBtnTitle}
                </button>
              ) : (
            ...
            <div className="container">
              <div className="pool_party_content">
                ...
                <div className="pool_content_area">
                  <h3 className="title-3">What Is The Spring Splash Bash?</h3>
                  <p>
                    Simple, the Drinks on Deck Spring Splash Bash is a digital “pool
                    party” and raffle all in one <br />
                    that anyone can participate in. On March 25th at XX:XX the party
                    kicks off and every ticket <br />
                    will reveal if its a winning or losing ticket.
                  </p>
                  <p>
                    The best part? Almost 50% of tickets will win something! <br />
                    Prizes consist of, SOL, USDC, Drinks on Deck Whitelist access with
                    special mint pricing, S Tier <br />
                    NFTs, and much more!
                  </p>
                </div>
              </div>
                ...
                <div className="faq_area">
                  <div className="accordion" id="accordionExample">
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingOne">
                        ...
                        >
                          <h4 className="title-4">What can I win?</h4>
                        </button>
                      </h2>
                      <div
                        id="collapseOne"
                      ...
                      >
                        <div className="accordion-body">
                          <p className="text-3">
                            Prizes consist of, SOL, USDC, Drinks on Deck Whitelist
                            access with special mint pricing, S Tier NFTs, and much
                            more!
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingTwo">
                        ...
                        >
                          <h4 className="title-4">Are tickets tradable?</h4>
                        </button>
                      </h2>
                      <div
                        id="collapseTwo"
                      ...
                      >
                        <div className="accordion-body">
                          <p className="text-3">
                            Yes! Tickets are tradable on Magic Eden. Maximize your
                            chances and prizes by buying additional tickets. How much
                            is a ticket worth if it’s redeemable for a DeGod after
                            reveal?
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        ...
                        >
                          <h4 className="title-4">What is Pool Party?</h4>
                        </button>
                      </h2>
                      <div
                        id="collapseThree"
                      ...
                      >
                        <div className="accordion-body">
                          <p className="text-3">
                            Pool Party is a DeFi platform focused on gamifying DeFi to
                            help increase positive habits. Check out our flagship
                            protocol and learn more at
                            <a target="_blank" href="https://joinpoolparty.io/" rel="noreferrer">
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingfour">
                        ...
                        >
                          <h4 className="title-4">What is Drinks on Deck?</h4>
                        </button>
                      </h2>
                      <div
                        id="collapsefour"
                      ...
                      >
                        <div className="accordion-body">
                          <p className="text-3">
                            Drinks on Deck are you’re delightful poolside companions
                            and Pool Party’s flagship NFT project. Funds from the
                            Drinks on Deck mint will be staked to create an eternal
                            lottery for Drinks on Deck holders. Stake your Drink to be
                            eligible to win prizes generated from the yield. Holders
                            will get to determine how often the drawing occurs, how
                            many winners each draw has and so much more!
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="minit_items_area">
                    <ul>
                      <li>
                        <a href="#">
                          <Image src={ray1} alt="rays_1" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <Image src={ray2} alt="rays_2" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <Image src={ray3} alt="rays_3" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <Image src={ray4} alt="rays_4" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <Image src={ray5} alt="rays_5" />
                        </a>
                      </li>
                    </ul>
                  </div>
